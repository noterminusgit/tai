defmodule Tai.Events.FundingTest do
  ...
  test "struct has required fields" do
    ...
    {:ok, interval, _} = DateTime.from_iso8601("2020-01-24T08:00:00.000+00:00")

    event =
      struct!(Tai.Events.Funding,
        venue_id: :my_venue,
        symbol: :btc_usd,
        timestamp: timestamp,
    ...
    assert Decimal.eq?(event.rate, Decimal.new("0.0001"))
    assert Decimal.eq?(event.rate_daily, Decimal.new("0.0003"))
  end
