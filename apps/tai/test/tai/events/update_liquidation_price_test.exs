defmodule Tai.Events.UpdateLiquidationPriceTest do
  ...
  test "struct has required fields" do
    ...
    event =
      struct!(Tai.Events.UpdateLiquidationPrice,
        venue_id: :my_venue,
        symbol: :btc_usd,
        received_at: received_at,
        price: Decimal.new("44500.00"),
    ...
    assert Decimal.eq?(event.price, Decimal.new("44500.00"))
