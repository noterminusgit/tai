defmodule Tai.Events.PositionUpdateTest do
  ...
  test ".to_data/1 returns the struct as a map" do
    ...
    assert json.data == %{side: :long, qty: 100}
  end
end
